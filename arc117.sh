...
echo "${RED_TEXT} ${BOLD_TEXT} Enter LOCATION: ${RESET_FORMAT}"
read -r LOCATION
echo
...
echo "${RED_TEXT}${BOLD_TEXT} Enabling required services (datacatalog & dataplex)... ${RESET_FORMAT}"
echo
gcloud services enable datacatalog.googleapis.com
gcloud services enable dataplex.googleapis.com

echo
echo "${RED_TEXT}${BOLD_TEXT} Creating Dataplex Lake ----> customer-engagements ${RESET_FORMAT}"
echo
...
echo
echo "${RED_TEXT}${BOLD_TEXT}  Creating Dataplex Zone ----> raw-event-data ${RESET_FORMAT}"
echo
...
echo
echo "${RED_TEXT}${BOLD_TEXT} Creating Dataplex Asset ----> raw-event-files  ${RESET_FORMAT}"
echo
...
echo
echo "${RED_TEXT}${BOLD_TEXT} Creating ------> Protected Raw Data Template ${RESET_FORMAT}"
echo
...
echo
echo "${RED_TEXT}${BOLD_TEXT} Making ----> raw-event-data zone as protected raw data ${RESET_FORMAT}"
echo
